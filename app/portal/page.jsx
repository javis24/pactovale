...
const theme = {
  primary: "#ff5aa4", // Tu nuevo color rosa
  light: "#FFFFFF",   // Blanco puro para contrastar
  textInfo: "#FFE0EE" // Un tono rosa muy claro para textos secundarios
};

// =================================================================
// 1. COMPONENTE PADRE (ORQUESTADOR)
// =================================================================
...
// =================================================================
// 2. COMPONENTE: WELCOME (BIENVENIDA)
// =================================================================
function WelcomeView({ onNavigate }) {
  return (
    <div className="h-full flex flex-col items-center p-8 text-center animate-fade-in relative z-10">
      ...
      {/* Botones (Posicionados más arriba como pediste) */}
...
// =================================================================
// 3. COMPONENTE: LOGIN (INICIO DE SESIÓN)
// =================================================================
function LoginView({ onNavigate }) {
  ...
  const handleLogin = async (e) => {
    ...
    if (res.error) {
      ...
      router.push("/admin/dashboard"); // Redirige al panel
      router.refresh();
    }
  };
...
// =================================================================
// 4. COMPONENTE: REGISTER (REGISTRO COMPLETO)
// =================================================================
  ...
  return (
     ...
     <div className="flex-1 overflow-y-auto px-8 py-6">
       <form onSubmit={handleRegister} className="flex flex-col gap-4 pb-10">
         ...
         {/* Campos extra requeridos por tu Base de Datos */}
